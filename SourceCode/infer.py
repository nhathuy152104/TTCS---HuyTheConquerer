...
from dataloader.dataset import collate_fn_BEV,SemKITTI,SemKITTI_label_name,spherical_dataset,collate_fn_BEV_test
...
def main(args):
    ...
    # validation
    print("val samples =", len(val_pt_dataset))
    print("test samples =", len(test_pt_dataset))

    print("val spherical =", len(val_dataset))
    print("test spherical =", len(test_dataset))

    print("val loader =", len(val_dataset_loader))
    print("test loader =", len(test_dataset_loader))
    print('*'*80)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data_dir', default='Z:\HuyWorkSpace\Panoptic-PolarNet-main\Panoptic-PolarNet-main\dataset')
